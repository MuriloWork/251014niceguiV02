...
# web application at http://muWork01.pythonanywhere.com/
...
#import sys
#
#path = '/home/muWork01/path/to/my/app
...
#import sys
#
## assuming your django settings file is at '/home/muWork01/mysite/mysite/settings.py'
## and your manage.py is is at '/home/muWork01/mysite/manage.py'
#path = '/home/muWork01/mysite'
#if path not in sys.path:
#    sys.path.append(path)
#
...
#import sys
#
## The "/home/muWork01" below specifies your home
## directory -- the rest should be the directory you uploaded your Flask
## code to underneath the home directory.  So if you just ran
## "git clone git@github.com/myusername/myproject.git"
## ...or uploaded files to the directory "myproject", then you should
## specify "/home/muWork01/myproject"
#path = '/home/muWork01/path/to/flask_app_directory'
#if path not in sys.path:
#    sys.path.append(path)
#
